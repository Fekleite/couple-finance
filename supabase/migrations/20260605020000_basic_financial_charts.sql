...
create index if not exists financial_transactions_charts_expense_category_idx
  on public.financial_transactions (transaction_date, category_code)
  where transaction_type = 'expense';

create index if not exists financial_transactions_charts_shared_responsible_idx
  on public.financial_transactions (shared_budget_id, responsible_user_id, transaction_date)
  where visibility = 'shared' and transaction_type = 'expense';
